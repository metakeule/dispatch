...
func main() {
	...
	// we have fallback functions for unhandled types
	...
	d.SetHandler("", func(in interface{}, out interface{}) (err error) {
		fmt.Printf("%s is a string\n", in.(string))
		return
	})

	d.SetHandler(I(0), func(in interface{}, out interface{}) (err error) {
		fmt.Printf("%d is a I\n", in.(I))
		return
	})
